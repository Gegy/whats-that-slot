...
public final class SlotQueryProgressBar extends AbstractGui {
    ...
    public SlotQueryProgressBar(ContainerScreen<?> screen, Slot slot) {
        Bounds2i screenBounds = Bounds2i.ofScreen(screen);
        this.x0 = screenBounds.x0() + slot.x;
        this.y0 = screenBounds.y0() + slot.y;
    }

    public void draw(MatrixStack matrices, float progress) {
